...
class AdminMiddleware {
    ...
    public static async authenticate(
        ...
        const site = await AdminMiddleware._getAndCacheSiteInfo(domain);
        ...
        if (authHeader && authHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                await AdminMiddleware.checkSiteAndUser(site, decoded);
        ...
        if (apiKey) {
            try {
                ...
                if (authenticatedUser) {
                    ...
                    await AdminMiddleware.checkSiteAndUser(site, authenticatedUser);
